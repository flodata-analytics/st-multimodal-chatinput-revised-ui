    ...
    return (
      <div style={{ position: "relative", display: "flex", flexDirection: "column", border: "1px solid gray", borderRadius: "8px", padding: "8px", width: width }} >
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          {/* Send Button */}
          <button disabled={isdisabled} onClick={this.handleSubmit} style={{ marginLeft: "10px", padding: "5px 10px", borderRadius: "4px", backgroundColor: "#f0f2f6", color: "#black", border: "1px solid #ccc", ...(isdisabled ? this.disabledStyle : {}) }}>
            ➤
          </button>
        </div>
      </div>
